...
<!-- BEGIN STM32_OS_CURRENT_HANDOFF -->
## Current authoritative handoff

### Published firmware and architecture baselines

Live repository HEAD is intentionally not hard-coded in the handoff because docs-only reconciliation commits may advance it without changing accepted product/source identity. Exact live Git state must be verified directly when needed.

The latest completed product boundary remains `HOST_CONTROL_APPLICATION_FOUNDATION`, published at `e0f49f168542fa1cf49bca451e01b0c077aa8d18`, tree `42c77f2cf3d7e9f7f5c1ff24d9d437f61a397be6`.

Accepted firmware candidate: tree `b895955f7738aceb6fca0272d510cc433378c6ab`, BIN `50652` bytes / SHA-256 `FB68993FC998DE77B61FAF9F4949E4E124B95FF867BB456EBA401C9F2709F13F`, Flash/SRAM `50652/11728`. Accepted host candidate: tree `2c5afd9914851300aed15e321cf69c3a2c3daeed`, `net10.0`, Windows WinUSB, Linux libusb, Avalonia `12.1.2`, Core/Transport tests `21/21` and `5/5`. Gates 0–7 are complete and publication ended clean at ahead/behind `0/0`.
...
### Published application/UI architecture foundation
...
### Published OLED optimization boundary
...
**`HOST_CONTROL_APPLICATION_FOUNDATION` — Gates 0–7 accepted / published `e0f49f168542fa1cf49bca451e01b0c077aa8d18` (tree `42c77f2cf3d7e9f7f5c1ff24d9d437f61a397be6`). Next boundary is `ASSET_CONFIGURATION_TRANSFER_FOUNDATION` Gate 0 contract freeze.**

Accepted Host Control candidate uses firmware tree `b895955f7738aceb6fca0272d510cc433378c6ab` and host tree `2c5afd9914851300aed15e321cf69c3a2c3daeed`; BIN is `50652` bytes / `FB68993FC998DE77B61FAF9F4949E4E124B95FF867BB456EBA401C9F2709F13F`; Flash/SRAM are `50652/11728`; Core/Transport tests are `21/21` and `5/5`. Windows CLI, Windows Desktop and real Linux hardware/runtime are accepted, including fresh reconnect negotiation, 128 unique management pings, zero management/CDC drops and exact final Flash readback.

Next work is documentation-only Gate 0 for `ASSET_CONFIGURATION_TRANSFER_FOUNDATION`: freeze the real v1 consumer, schema/version, maximum size, exact Flash ownership region, integrity, atomic recovery, erase/program alignment, wear budget and incompatible-version policy before any persistent write.

Host Control publication commit/tree: `e0f49f168542fa1cf49bca451e01b0c077aa8d18` / `42c77f2cf3d7e9f7f5c1ff24d9d437f61a397be6`; ordinary non-force push complete; final ahead/behind `0/0`. Gate 7 evidence/log SHA-256 are `638569FE26600013B3B6717C76DEBF3251980B06D0B493B835D96CB4BC0CFD8F` / `5BCA12F1E58C2749DD41C81469EA9875DE1877EEF75F306FD622399F569FE5E7`.

### Historical accepted implementation baselines

Kernel composition-root decomposition acceptance: `src/kernel.c 5100 -> 3405` lines (-33.235%). `application_runtime_bridge` owns mutable application runtime integration state/event snapshot/view adaptation; `application_commands` owns `rpcinfo/applist/appstart/appstop`; `scheduler_diagnostics` owns diagnostic orchestration; root-private production scheduler observability remains in the composition root. Exact source boundary is seven paths and no command-service expansion was needed.
...
Post-decomposition architecture debt is explicitly deferred in `docs/DEFERRED_OPTIMIZATION_ROBUSTNESS_BACKLOG.md`: further `kernel.c` composition-root convergence; system/service state becoming upstream of UI rather than reconstructed from presentation state; splitting OLED adaptation from `application_runtime_bridge` only when a second presentation consumer exists; preserving `scheduler_diagnostics` as a synchronous/non-reentrant borrowed-binding contract unless a dedicated concurrent model is accepted; and freezing fail-closed stop semantics before applications can own resources whose release may fail. None of these items blocked the subsequently published USB-management or Host Control boundaries, and none authorizes speculative HAL/framework/god-context work.

Published USB management Gates 0–7 are **PASS** on repaired descriptor candidate tree `46841b52d351277deb134a6f4709619087b477af`: BIN `50172` / SHA-256 `FD0A8049193772892C2A3DC1CF2B24FA17BCC83FC4B0F55A22AA6A4962C864FB`, Flash/SRAM `50172/11728` within frozen ceilings `54780/11824`, task stacks `1024/512`, undefined symbols `0`, stack-usage files `21/21`. Gate 2 evidence/log SHA-256 are `B6101C2FAD615DC41856BD1DE88C46E92517759EC3AC1F56ACB2030B89252AF3` / `245F15303355C47473C15CB05838DB495764F97D228DB1113B3C7693765D429F`. Gate 3 composite hardware acceptance (`v11+v14`) proves automatic inbox WinUSB binding on management interface 2, exact protocol/service/registry surface, application lifecycle and rejection/recovery behavior, real physical USB reconnect, authorized IWDG reboot/recovery with bounded return to `system.home`, WinUSB pressure `128/128`, CDC parser/partial-frame isolation, CDC binary continuity, UART `32/32`, management RX/TX drops `0/0`, task margins `448/424`, intact canaries/zero scheduler faults, and final Flash exactly equal to the Gate-2 BIN. Gate 3 evidence/log SHA-256 are `1EF8595E85F088F0D3870CA5D880631342AD795FDB94C05EAB9BBC3566A3DCC6` / `083C9B66B7225D3FF37845996B62991C7DE8E84332BD3C8B059F1B8A6569797B`; no Flash was performed in the final continuation. The exact five-path Gate 1 implementation boundary plus two-path binary-RPC SRAM remediation remains unchanged. Composite identity is `1209:000C` / `Deus OS Device`, CDC interfaces 0–1 under IAD, management interface 2 `FF/00/00` over EP4 `0x04/0x84` bulk64, PMA `0x180/0x1C0`, MS OS 2.0 vendor code `0x20` / set length `178` / first-configuration subset selector `0`, `WINUSB` only for IF2, stable GUID `{C8B05EDE-1683-5002-81F0-95636B89CEC6}`. Gate 4 is `PHYSICAL_OLED=N/A_UNCHANGED_UI_AUTOMATED_REGRESSION_PASS`; OLED/UI/application-rendering source did not change. Gate 5 documentation finalization is PASS; Gate 6 committed the exact accepted source/docs set as `1f88083843c6aae9fd228ad2d677f9252b889a11`, tree `931f1cbce8bc7c043bf27626c6127ac7cab9acb9`; Gate 7 published it by ordinary non-force push and fresh fetch proved `HEAD == origin/main == FETCH_HEAD`, clean, ahead/behind `0/0`. `HOST_CONTROL_APPLICATION_FOUNDATION` was subsequently completed through Gate 7 and published at `e0f49f168542fa1cf49bca451e01b0c077aa8d18`. Canonical design/acceptance remain `docs/HOST_CONTROL_APPLICATION_FOUNDATION_PLAN.md` and `docs/HOST_CONTROL_APPLICATION_FOUNDATION_ACCEPTANCE_PLAN.md`.

Host Control Application foundation is accepted through Gate 7 and published on firmware tree `b895955f7738aceb6fca0272d510cc433378c6ab` and host tree `2c5afd9914851300aed15e321cf69c3a2c3daeed`. Accepted artifacts are BIN `50652` / `FB68993FC998DE77B61FAF9F4949E4E124B95FF867BB456EBA401C9F2709F13F`, ELF `483488` / `978CC710497F79E9A3AFBAFE3E0CD3AE10BA2B6CF0FE6AA7518B7AC5BC5E524C`, MAP `207952` / `F9806E2A71476D6D2DAC2CD481A6C491BACD18CADD713813BB69AF9DA608C032`; Flash/SRAM are `50652/11728` within frozen ceilings `54780/11824`. Host target is `net10.0`; Avalonia is `12.1.2`; Windows SDK acceptance used `10.0.201`, Linux used `10.0.112`; Core/Transport tests are `21/21` and `5/5`. Windows CLI/hardware Gate 3, malformed-vector amendment and Windows Desktop Gate 4 pass. Real Linux Gate 5 on Ubuntu 26.04.1 claims management IF2 only, preserves CDC IF0/1, passes 128 unique pings and same-session physical reconnect with stable `usb:001:8` locator despite device address `007 -> 008`. Final SRAM diagnostics show USB error/PMA `0/0`, management packets RX/TX `13/113`, management drops `0/0`, CDC drops `0/0`; final Flash readback is exact. Gate 4 target OLED disposition is `PHYSICAL_OLED=N/A_UNCHANGED_UI_AUTOMATED_REGRESSION_PASS`. Final Gate 5 composite evidence/log are `564BF507C54D802ACD590012384A6FA2BE7483C40F94654802C5316071702BFE` / `BFF093889489077BBF60B97E083D34082ECF8AE40322E2710EA2B77FF2893591`. Gate 6 produced one normal local acceptance commit `e0f49f168542fa1cf49bca451e01b0c077aa8d18`; Gate 7 published it by ordinary non-force push and fresh post-push fetch proved clean ahead/behind `0/0`. Gate 7 evidence/log are `638569FE26600013B3B6717C76DEBF3251980B06D0B493B835D96CB4BC0CFD8F` / `5BCA12F1E58C2749DD41C81469EA9875DE1877EEF75F306FD622399F569FE5E7`. Next: `ASSET_CONFIGURATION_TRANSFER_FOUNDATION` Gate 0 contract freeze; no persistent write is authorized before version/size/Flash-region/integrity/atomic-recovery/wear policy is frozen.
<!-- END STM32_OS_CURRENT_HANDOFF -->
## Project identity
