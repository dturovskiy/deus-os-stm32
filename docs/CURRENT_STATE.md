...
1. Flash wear/timing/watchdog/USB continuity model;
2. deterministic reset/power-loss fault-injection matrix;
3. recovery-bundle / ST-LINK restoration procedure.
