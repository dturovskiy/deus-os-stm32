...
Accepted source boundary is new `include/kernel/application_runtime.h`, new `src/kernel/application_runtime.c`, plus `include/kernel/command_service.h`, `src/kernel/command_service.c`, and `src/kernel.c`. Gate 2/3 candidate tree `ba8b7066c8c435b7bca4fdef3932f27c5055761c` uses Flash `48604/65536`, SRAM `10032/20480`, and hardware minimum task0/task1 margins `272/424` bytes after full application/binary activity. Evidence SHA-256: Gate 2 `75719A35004401F9A941E187EC93978961252388B03F892DE98CBA40479492A6`; Gate 3 `1158485D1A0C90FA4931589F10298154E6522A568220A48C4A6BE67EFA54FC52`; Gate 4 `ED0F022A60174AEEA487B64216885AFA72D768CA81CF60E14A347DEAC58B2F86`; Gate 5 `817D12D74D88F1C0F31C502B0715F038FF356382E56FC0D5421DC237239D78BC`. Gate 6/7 publication is complete at commit `25752fba557b1a1b518265a93bde05d3a6a3f9ad`, tree `24624db70923bdaa77f134cc956423511785c199`; Gate 6 evidence `203F9A99E09F76C7F99B6C06EF073BE4F55949545188F7302E394AB20AEED068`, Gate 7 evidence `855FC891003E1A67EBF6C5FDE559EEF0F1450A83828FCF66EFC6D00DB3C51EBB`. `KERNEL_COMPOSITION_ROOT_DECOMPOSITION` Gates 0–7 are published at `fa75307fb392718a1d10d52770a6a111c97208e7`; canonical design/acceptance are `docs/KERNEL_COMPOSITION_ROOT_DECOMPOSITION_PLAN.md` and `docs/KERNEL_COMPOSITION_ROOT_DECOMPOSITION_ACCEPTANCE_PLAN.md`. `USB_MANAGEMENT_DEVICE_FOUNDATION` Gates 0–7 are accepted/published at commit `1f88083843c6aae9fd228ad2d677f9252b889a11`, tree `931f1cbce8bc7c043bf27626c6127ac7cab9acb9`; its canonical design/acceptance are `docs/USB_MANAGEMENT_DEVICE_FOUNDATION_PLAN.md` and `docs/USB_MANAGEMENT_DEVICE_FOUNDATION_ACCEPTANCE_PLAN.md`. `HOST_CONTROL_APPLICATION_FOUNDATION` is accepted through Gate 7 and published at `e0f49f168542fa1cf49bca451e01b0c077aa8d18`; its canonical design/acceptance are `docs/HOST_CONTROL_APPLICATION_FOUNDATION_PLAN.md` and `docs/HOST_CONTROL_APPLICATION_FOUNDATION_ACCEPTANCE_PLAN.md`. The current next boundary is `ASSET_CONFIGURATION_TRANSFER_FOUNDATION` Gate 0 contract freeze. After the initial `12232/11824` SRAM failure, the reviewed binary-RPC scratch-workspace remediation preserved the fixed rings and independent transport state; the later Windows Code-28 investigation corrected the MS OS 2.0 first-configuration subset selector to `0` and advanced `bcdDevice` to `1.02`. Gate 2 rebuild acceptance is candidate tree `46841b52d351277deb134a6f4709619087b477af`, BIN `50172` / SHA-256 `FD0A8049193772892C2A3DC1CF2B24FA17BCC83FC4B0F55A22AA6A4962C864FB`, Flash/SRAM `50172/11728`; task stacks `1024/512`, undefined symbols `0`, stack-usage `21/21`, no Flash and no real-index mutation. Gate 2 evidence `B6101C2FAD615DC41856BD1DE88C46E92517759EC3AC1F56ACB2030B89252AF3`; log `245F15303355C47473C15CB05838DB495764F97D228DB1113B3C7693765D429F`. Gate 3 composite hardware acceptance (`v11+v14`) passes with automatic inbox WinUSB binding, full WinUSB RPC/error/recovery coverage, physical reconnect, authorized IWDG recovery, WinUSB pressure `128/128`, UART `32/32`, management drops `0/0`, task margins `448/424`, and exact final Flash readback. Gate 3 evidence/log SHA-256 are `1EF8595E85F088F0D3870CA5D880631342AD795FDB94C05EAB9BBC3566A3DCC6` / `083C9B66B7225D3FF37845996B62991C7DE8E84332BD3C8B059F1B8A6569797B`. Gate 4 is `PHYSICAL_OLED=N/A_UNCHANGED_UI_AUTOMATED_REGRESSION_PASS` because OLED/UI/application-rendering source is unchanged.

The accepted decomposition reduces `src/kernel.c` from `5100` to `3405` lines (-33.235%) and moves coherent ownership into `application_runtime_bridge`, `application_commands`, and `scheduler_diagnostics` while retaining root-private production scheduler observability in the composition root. No `kernel_context_t`, service locator, hidden extracted-state extern, heap, new task/SVC/queue/mutex/generic timer/DMA/persistence machinery or dependency cycle was introduced.

Accepted candidate tree `883cecc8d78306fa28b252332dc9d654fde95b5a`; BIN `48636` bytes / `51083C63652DCFCCC479604CA09E191EAB43561C496E2D6F1E5DAABC10CC9766`; ELF `83FD4C9B9589A7E1B619A3B0C82BF2AB9050D5B4572DAD30BA1414CA8354CF8B`; MAP `0BB014FAA418374AFDC77EE9389B3D7BCE631FB0D33EA451952142F78DCC2AD8`; Flash `48636/65536`, SRAM `10032/20480`, final task0/task1 margins `384/424`. Gate 2 evidence `E46AD8B481D612D29F9E514106D11A9FAF861FA0CAF22AF6764D2711B6485549`; Gate 3 evidence `2FE593A80FB42BF3808AFAE397A3205FD64824873FF867ED3277D91010AFAC42`; Gate 4 `PHYSICAL_OLED=PASS`.
<!-- END STM32_OS_IMPLEMENTATION_CHECKPOINT -->
## Objective
